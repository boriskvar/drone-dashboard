...
@section('title', 'Редактировать координаты трека')
...
<div class="container mt-4">
    ...
    <form method="POST" action="{{ route('admin.simulate_tracks.update', $simulateTrack) }}">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <select name="drone_id" id="drone_id" class="form-select @error('drone_id') is-invalid @enderror" required>
                ...
                <option value="{{ $drone->id }}"
                        {{ old('drone_id', $simulateTrack->drone_id) == $drone->id ? 'selected' : '' }}>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="latitude" id="latitude" step="0.0001"
                   ...
                   value="{{ old('latitude', $simulateTrack->latitude) }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="longitude" id="longitude" step="0.0001"
                   ...
                   value="{{ old('longitude', $simulateTrack->longitude) }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="altitude" id="altitude" step="0.01"
                   ...
                   value="{{ old('altitude', $simulateTrack->altitude) }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="speed" id="speed" step="0.01"
                   ...
                   value="{{ old('speed', $simulateTrack->speed) }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="heading" id="heading" step="0.1"
                   ...
                   value="{{ old('heading', $simulateTrack->heading) }}">
