...
<div class="container mt-4">
    ...
    <a href="{{ route('admin.flight_data.create') }}" class="btn btn-primary mb-3">
        ➕ Добавить данные
    </a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex gap-1">
                        <a href="{{ route('admin.flight_data.edit', $flight) }}" class="btn btn-sm btn-primary"
                           title="Редактировать">
                            ✏️
                        </a>

                        <form action="{{ route('admin.flight_data.destroy', $flight) }}" method="POST"
