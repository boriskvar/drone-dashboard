...
<div class="container mt-4">
    ...
    <form action="{{ route('admin.flight_data.store') }}" method="POST">
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="number" name="latitude" id="latitude" step="0.0000001" class="form-control" value="{{ old('latitude') }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="longitude" id="longitude" step="0.0000001" class="form-control" value="{{ old('longitude') }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="altitude" id="altitude" step="0.1" class="form-control" value="{{ old('altitude') }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="speed" id="speed" step="0.1" class="form-control" value="{{ old('speed') }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="heading" id="heading" step="0.1" class="form-control" value="{{ old('heading') }}">
        ...
        <a href="{{ route('admin.flight_data.index') }}" class="btn btn-secondary">Назад</a>
    </form>
</div>
@endsection