...
<div class="container mt-4">
    <h1 class="mb-4">Добавить позицию дрона</h1>
    ...
    <form action="{{ route('admin.simulate_positions.store') }}" method="POST">
        @csrf
        ...
        <a href="{{ route('admin.simulate_positions.index') }}" class="btn btn-secondary">Назад</a>
    </form>
</div>
@endsection
